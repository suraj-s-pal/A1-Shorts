...
import com.surajpal.a1_shorts.adapter.ProfileVideoAdapter
import com.surajpal.a1_shorts.databinding.ActivityProfileBinding
...
class ProfileActivity : AppCompatActivity() {
    ...
    fun setUI() {
        profileUserModel.apply {
            ...
            if (profileUserModel.followerList.contains(currentUserId)) binding.profileBtn.text =
                "Unfollow"
